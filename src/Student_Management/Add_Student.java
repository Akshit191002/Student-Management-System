...
public class Add_Student implements ActionListener
{
    ...
    Add_Student()
    {
        ...
        id.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Student_Management/Icon/add.jpg"));
        ...
        id7.setBounds(450,300,200,30);
        id7.setFont(new Font("Airal",Font.BOLD,20));
        id.add(id7);
        t6=new JTextField();
        t6.setBounds(650,300,150,30);
        id.add(t6);
        ...
        id9.setBounds(450,350,200,30);
        id9.setFont(new Font("Airal",Font.BOLD,20));
        id.add(id9);
        t8=new JTextField();
        t8.setBounds(650,350,150,30);
        id.add(t8);
        
        id10=new JLabel("PHONE NUMBER");
        id10.setBounds(450,250,200,30);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        String dep=t6.getText();
        String yr=t7.getText();
        String adh=t8.getText();
        String phn=t9.getText();
        String eid=t10.getText();
        String sid=t11.getText();
        ...
        if(e.getSource()==b)
        {
            try
            {
                ...
                String q="insert into Student value('"+name+"','"+lname+"','"+fname+"','"+dob+"','"+address+"','"+dep+"','"+yr+"','"+adh+"','"+phn+"','"+eid+"','"+sid+"')";
